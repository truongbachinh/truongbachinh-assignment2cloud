...
(1, 'Harry Potter Box Set: The Complete Collection', 2030000, 'J. K. Rowling', 'Arttoy', 'A beautiful boxed set containing all seven Harry Potter novels in paperback. These new editions of the classic and internationally bestselling, multi-award-winning series feature instantly pick-up-able new jackets by Jonny Duddle, with huge child appeal, to bring Harry Potter to the next generation of readers.', 'https://drive.google.com/open?id=1UhBOzqqQKKJzjyNS359KCh13KdNSgfJD'),
...
(1, 'Outcomes Pre-Inter (Asia Ed.): Student toy with Pincode Only', 216000, 'Cengage', 'Cengage', 'Nothing', 'Outcomes.jpg'),
...
(1, 'American Inspiration 2: Student toy with CD-Rom', 470000, 'Macmillan Education', 'Macmillan Education', 'Nothing', 'American.jpg'),
